...
// HTTP behaviour is covered in geo_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "geo://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("geo", "about")
	if err != nil || got.String() != "geo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want geo://page/about", got.String(), err)
	}
}
