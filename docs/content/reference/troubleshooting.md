...
Most of these come down to network reality or how geo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

geo rate-limits like any public site. geo already paces
...
Where a surface is gated, geo reads a cookie or token you supply
...
`geo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what geo actually did
